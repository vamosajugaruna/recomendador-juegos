...
${j["Alta valoración"] === "Si" ? `<span class="badge badge-estrella" data-filtro="Alta valoración" data-valor="Si">⭐ Alta valoración en BGG</span>` : ''}
${j["Spiel"] === "Si" ? `<span class="badge badge-spiel" data-filtro="Spiel" data-valor="Si">🏆 Premio Spiel des Jahres</span>` : ''}
${j["Viral"] === "Si" ? `<span class="badge badge-viral" data-filtro="Viral" data-valor="Si">🔥 Juego viral</span>` : ''}
${j["Favorito"] === "Si" ? `<span class="badge badge-favorito" data-filtro="Favorito" data-valor="Si">🎯 Favorito del canal</span>` : ''}
...
document.addEventListener("click", function (e) {
  if (e.target.classList.contains("tag") || e.target.classList.contains("badge")) {
    ...
    // Si el filtro existe como input o select en el DOM, lo aplicamos
    const input = document.getElementById(filtro);
    if (input) {
      input.value = valor;
      filtrar();
    } else {
      // Si es un badge que no está en el formulario, filtramos manualmente sin alterar la variable original
