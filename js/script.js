...
function filtrar() {
  ...
  // Si no hay filtros y se quiere ordenar todo el listado
  const aplicarOrden = (lista) => {
    switch (orden) {
      case "nombre":
        return lista.sort((a, b) => a.Nombre.localeCompare(b.Nombre));
      case "duracion":
        return lista.sort((a, b) => (a.Duracion || 0) - (b.Duracion || 0));
      case "precio":
  ...
  const juegosOrdenados = aplicarOrden(juegosFiltrados);
